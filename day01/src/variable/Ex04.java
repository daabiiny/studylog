...
public class Ex04 {
	public static void main(String[] args) {
		// 기본 자료형 (primitive type) * 첫글자가 소문자
...
//		int num = "점심식사"
		...
		// 이미 선언된 변수는 자료형이 나타나지 않지만, 툴팁이나 링크 따라가기
		// 등으로 확인이 가능하다
//		age = "배고파";
