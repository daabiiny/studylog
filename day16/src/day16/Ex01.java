...
/*
  	...
  	-> 함수, 메서드의 재사용 : 클래스에 출력메서드를 한번만 작성해두면, 여러 객체가 동일한 메서드를 호출하여 사용
  	-> 클래스의 재사용 : 상속(extends, implements)을 통해 만들어진 클래스를 기반으로 새로운 내용을 만들 수 있다
  	 ...
  	 특정 자료형을 명시하지 않은, 코드 및 현실에 존재하는 모든 객체를 나타낼 때는 object라고 표현한다
  	 특정 클래스에 의해 만들어진 객체는, 클래스를 실체화 했다고 하여 instance라고 표현한다
