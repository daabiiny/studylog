...
public class Quiz5 {
	public static void main(String[] args) {
		...
		if (min == distA)		System.out.println("A엘리베이터가 옵니다");
		else if (min == distB)	System.out.println("B엘리베이터가 옵니다");
		else 					System.out.println("C엘리베이터가 옵니다");
