...
public class Ex05 {
	// tip
	// 이클립스에서 static 요소는 이탤릭(기울임꼴)이 적용된다
	// 이클립스에서 final 요소는 볼드체(굵게)가 적용된다
	public static void main(String[] args) {
		
		System.out.println("Test5타입의 객체 수 : " + Test5.getCount());
...
//		Test5.setCount(1);	// 클래스로 접근해도 마찬가지
		...
		// non-static (name, age) 필드는 객체마다 서로 다른 값을 저장하지만
		// static (count) 필드는 클래스에 속한 값이며, 서로 다른 객체가 같은 값을 공유한다
