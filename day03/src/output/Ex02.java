...
public class Ex02 {
	public static void main(String[] args) {
		...
		// 서식은 믄자열이기 때문에, 별도의 변수에 저장해두었다가 활용할 수도 있다
...
*/
		...
		// 실수의 서식 (C언어와 달리 double도 %If를 사용하지 않고, %f만 사용한다)
		double db = 3.14;
		...
		System.out.println();
		// 한글에서 이 방식은 맞춰지지 않음
		// 이스케이프 시퀀스로 해결하면 된다 (tab, 시작지점으로부터 4칸 혹은 8칸 간격 배치)
