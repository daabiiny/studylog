...
//		배열에는 index가 존재하고, index는 항상 0부터 시작한다
		...
		/*
		 * index [0][1][2][3][4] arr = { 1, 3, 5, 7, 9 };
		 * 
		 * arr[0] = 1 시작지점 0에서 1칸(4byte)까지의 값을 읽어내라 arr[1] = 3 arr[2] = 5 arr[3] = 7
		 * arr[4] = 9
		 */
...
//		배열의 길이 (arr.length) : 배열의 전체 크기 / 단일 자료형의 크기
//		5 = 20 / 4
		int sum = 0;
		for (int i = 0; i < 5; i++) {
			if (arr[i] % 3 ==0) {
