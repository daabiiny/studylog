...
//		배열의 생성
		int[] arr1 = null;	// 배열을 가리킬 변수만 생성했음. 실제 배열은 없음
							...
							// 지금 당장은 가리킬 대상이 없다
							// primitive type이 아니기때문에 int[] arr1 = 0; 안됨
...
//		이때 배열의 각 값은 자료형에 대응하는 0값으로 자동 초기화가 이루어진다
...
//		null은 가리키는 대상이 없다는 뜻
		System.out.println("arr1 : " + arr1);	
		
//		자바의 배열은 그대로 출력하면 내부 값을 확인 할 수 없다
...
//		java.util.Arrays 클래스의 ★toString() 함수★를 이용하여 변환후 출력할 수 있다
		...
		arr4[4] = 99;	// 단, index가 length와 같을 수 없음에 항상 주의해야한다!
						// ★ index의 최대값은 length - 1이다!
		
//		arr4[5] = -1;	// java.lang.ArrayIndexOutOfBoundsException 에러
