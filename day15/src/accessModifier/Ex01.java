...
public class Ex01 {
	public static void main(String[] args) {
		...
		// 4) 접근 제한자 : 클래스 내부 멤버(필드, 메서드) 요소를 대상으로 하는 외부의 접근을 제한하는 키워드(예약어)
		// private : 클래스 내부에서의 접근만 허용한다
		// package : 접근제한자를 작성하지 않았을 때의 기본값, 같은 패키지 내부의 클래스까지 허용
		...
		// age멤버필드를 높은 장벽으로 가려두었기 때문에
		// age가 있다/없다를 판별할 수 없다
		// (안보이는 대상에 대입할 수 없기 때문에)
